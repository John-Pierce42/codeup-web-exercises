...
//     .then((results) => results.forEach(results => console.log(results.name)))
...
// let starWarsApi = fetch("http://swapi.dev/api/films")
//     .then((response) => {return response.json()})
//     .then((jsonData) => {
...
// console.log("here first", starWarsApi);
...
Promise.race([starWarsApi, pokemonAPI]).then((response) => {console.log(response)})