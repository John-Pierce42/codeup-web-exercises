...
myCar.features = ["power windows/power locks", "rev match","19' alloy wheels", "brembo breaks", "manual transmission"];
...
var carGarage = [myCar, sigOtherCar];
 console.log(carGarage);

myCar.turnOn = (function (){
    alert("Turning on the " + myCar.model + " !")
});
